      ...
      >
        ...
        <div className="relative h-full w-full">
          ...
          <div className="absolute top-4 left-4 z-50 bg-black/70 backdrop-blur-sm px-4 py-2 rounded-lg">
            ...
            <div className="text-white text-lg font-bold">{videoSections[currentSection].title}</div>
          </div>


          <div className="relative w-full h-[calc(95vh-88px)] bg-black flex items-center justify-center">
            <Button
            ...
            <div className="bg-slate-900 p-4 flex items-center justify-between w-full">
              <Button
                onClick={handlePrevious}
                variant="outline"
                ...
                {videoSections.map((_, index) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all ${
                      index === currentSection ? "bg-blue-500 w-8" : "bg-slate-600 hover:bg-slate-500"
                    }`}
